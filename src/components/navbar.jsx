  ...
  return (
    ...
    md:px-12 lg:px-20 xl:px-48 text-xl'>
        ...
        <div className="md:hidden lg:flex xl:w-1/3 xl:justify-center">
            <Link href='/' className="text-sm flex bg-black rounded-md p-1 font-semibold
            items-center justify-center">
                <span className="text-white mr-1">Josip</span>
                <span className="w-10 h-8 rounded bg-white text-black flex
                items-center justify-center">.dev</span>
            </Link>
        </div>
        {/* SOCIALS */}
        <div className="hidden md:flex  gap-4 w-1/3 justify-end">
            ...
            <Link href="/">
                <Image src="/twitter.png" alt="" width={26} height={26}/>
            </Link>
            <Link href="/">
