...
const PortfolioPage = () => {
  ...
  return (
    ...
    >
              ...
              >
                <div className="flex flex-col gap-8 text-white">
                  ...
                  <Link href={item.link} className="flex justify-end">
                    <button className="p-2 text-sm md:p-4 md:text-md lg:p-8 lg:text-lg bg-white
                     text-gray-600 font-semibold m-4 rounded">See Demo</button>
                  </Link>
                </div>
              </div>
            ))}
      ...
      text-center bg-gradient-to-b from-red-100 to-blue-100">
        ...
        <div className="relative">
          ...
          <Link
            href="/contact"
            className="w-16 h-16 md:w-28 md:h-28 absolute top-0 left-0 right-0 bottom-0 m-auto bg-black
